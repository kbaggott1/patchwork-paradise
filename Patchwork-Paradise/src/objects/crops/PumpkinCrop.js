...
export default class PumpkinCrop extends Crop {
    static TOTAL_GROW_TIME = 10
    static SPRITE_START = 18
    ...
    initSprites() {
        ...
        return sprites.splice(PumpkinCrop.SPRITE_START, Crop.GROW_STATES)
    }
    ...
    harvest() {
        return ItemFactory.CreateInstance(ItemType.Pumpkin)
    }
