...
export default class EggplantCrop extends Crop {
    static TOTAL_GROW_TIME = 10
    static SPRITE_START = 60
    ...
    initSprites() {
        ...
        return sprites.splice(EggplantCrop.SPRITE_START, Crop.GROW_STATES)
    }
    ...
    harvest() {
        return ItemFactory.CreateInstance(ItemType.Eggplant)
    }
