...
export default class RaddishCrop extends Crop {
    static TOTAL_GROW_TIME = 10
    static SPRITE_START = 42
    ...
    initSprites() {
        ...
        return sprites.splice(RaddishCrop.SPRITE_START, Crop.GROW_STATES)
    }
    ...
    harvest() {
        return ItemFactory.CreateInstance(ItemType.Raddish)
    }
