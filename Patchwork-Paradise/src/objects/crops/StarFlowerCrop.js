...
export default class StarFlowerCrop extends Crop {
    static TOTAL_GROW_TIME = 10;
    static SPRITE_START = 198;
    static FLOWER_GROW_STATES = 5;
    ...
    initSprites() {
        ...
        return sprites.splice(StarFlowerCrop.SPRITE_START, StarFlowerCrop.FLOWER_GROW_STATES)
    }
    ...
    harvest() {
        return ItemFactory.CreateInstance(ItemType.StarFlower)
    }
