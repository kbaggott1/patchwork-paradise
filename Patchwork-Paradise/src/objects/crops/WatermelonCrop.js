...
export default class WatermelonCrop extends Crop {
    static TOTAL_GROW_TIME = 10
    static SPRITE_START = 36
    ...
    initSprites() {
        ...
        return sprites.splice(WatermelonCrop.SPRITE_START, Crop.GROW_STATES)
    }
    ...
    harvest() {
        return ItemFactory.CreateInstance(ItemType.Watermelon)
    }
